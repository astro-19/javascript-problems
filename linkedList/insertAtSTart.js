...
class SinglyLinkedList {
  ...
  insertFirst(value) {
    // Call the insertAt method with index 0 to insert the node at the beginning
...
numList.displayList();
// Insert a new node with data value 100 at the beginning of the list
console.log("Insert 100 at first position:");
numList.insertFirst(new Node(100));
numList.displayList();
// Insert a new node with data value 10 at the beginning of the list
