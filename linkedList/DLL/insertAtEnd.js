...
class DoublyLinkedList {
  ...
  // Method to insert a new node at the last position in the list
  insertLast(value) {
    this.insertAt(this.length, value); // Call the insertAt method with the last position
  }
...
numList.printList();
// Insert a new node at the last position with value 12
console.log("Insert at last position and value = 12");
numList.insertLast(12);
numList.printList();
// Insert another new node at the last position with value 14
